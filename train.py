...
model_str = 'HighLevelGuidedFreqFusion'
...
if True:
    ...
    torch.save(checkpoint, os.path.join("models/HighLevelGuidedFreqFusion_" + timestamp + ".pth"))
    torch.save(checkpoint, os.path.join("models/HighLevelGuidedFreqFusion_latest.pth"))
